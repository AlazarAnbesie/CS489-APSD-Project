package cs489.project.carrentalmanagementsystem.security.filter;
...
public class JWTAuthFilter extends OncePerRequestFilter {
    ...
    public JWTAuthFilter(CarRentalUserDetailService carRentalUserDetailService, JWTManagementUtilityService jwtManagementUtilityService) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetails userDetails = carRentalUserDetailService.loadUserByUsername(username);
